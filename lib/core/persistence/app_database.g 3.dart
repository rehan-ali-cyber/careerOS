...
class $AppUsageLogsTable extends AppUsageLogs
    with TableInfo<$AppUsageLogsTable, AppUsageLog> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $AppUsageLogsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'app_usage_logs';
  @override
  VerificationContext validateIntegrity(
    Insertable<AppUsageLog> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  AppUsageLog map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return AppUsageLog(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
  ...
  @override
  $AppUsageLogsTable createAlias(String alias) {
    return $AppUsageLogsTable(attachedDatabase, alias);
  }
}

class AppUsageLog extends DataClass implements Insertable<AppUsageLog> {
  final int id;
  ...
  AppUsageLogsCompanion toCompanion(bool nullToAbsent) {
    return AppUsageLogsCompanion(
      id: Value(id),
  ...
  AppUsageLog copyWithCompanion(AppUsageLogsCompanion data) {
    return AppUsageLog(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('AppUsageLog(')
          ..write('id: $id, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, packageName, appName, durationSeconds, date);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is AppUsageLog &&
          other.id == this.id &&
...
class AppUsageLogsCompanion extends UpdateCompanion<AppUsageLog> {
  final Value<int> id;
  final Value<String> packageName;
  final Value<String> appName;
  final Value<int> durationSeconds;
  final Value<DateTime> date;
  const AppUsageLogsCompanion({
    this.id = const Value.absent(),
  ...
  AppUsageLogsCompanion.insert({
    ...
    required DateTime date,
       ...
       appName = Value(appName),
       date = Value(date);
  static Insertable<AppUsageLog> custom({
    Expression<int>? id,
  ...
  AppUsageLogsCompanion copyWith({
    Value<int>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('AppUsageLogsCompanion(')
          ..write('id: $id, ')
          ..write('packageName: $packageName, ')
          ..write('appName: $appName, ')
          ..write('durationSeconds: $durationSeconds, ')
...
class $UsageLimitsTable extends UsageLimits
  ...
  static const VerificationMeta _limitMinutesMeta = const VerificationMeta(
    'limitMinutes',
  );
  @override
  late final GeneratedColumn<int> limitMinutes = GeneratedColumn<int>(
    'limit_minutes',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('limit_minutes')) {
      context.handle(
        _limitMinutesMeta,
        limitMinutes.isAcceptableOrUnknown(
          data['limit_minutes']!,
          _limitMinutesMeta,
        ),
      );
    } else if (isInserting) {
      context.missing(_limitMinutesMeta);
    }
  ...
  UsageLimit map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return UsageLimit(
      ...
      limitMinutes: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}limit_minutes'],
      )!,
...
class UsageLimit extends DataClass implements Insertable<UsageLimit> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['id'] = Variable<int>(id);
    map['package_name'] = Variable<String>(packageName);
    map['limit_minutes'] = Variable<int>(limitMinutes);
  ...
  factory UsageLimit.fromJson(
    ...
    return UsageLimit(
      id: serializer.fromJson<int>(json['id']),
      packageName: serializer.fromJson<String>(json['packageName']),
      limitMinutes: serializer.fromJson<int>(json['limitMinutes']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'packageName': serializer.toJson<String>(packageName),
      'limitMinutes': serializer.toJson<int>(limitMinutes),
  ...
  UsageLimit copyWithCompanion(UsageLimitsCompanion data) {
    return UsageLimit(
      ...
      packageName: data.packageName.present
          ? data.packageName.value
          : this.packageName,
      limitMinutes: data.limitMinutes.present
          ? data.limitMinutes.value
          : this.limitMinutes,
  ...
  String toString() {
    return (StringBuffer('UsageLimit(')
          ..write('id: $id, ')
          ..write('packageName: $packageName, ')
          ..write('limitMinutes: $limitMinutes, ')
  ...
  @override
  int get hashCode => Object.hash(id, packageName, limitMinutes, isActive);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is UsageLimit &&
          other.id == this.id &&
          other.packageName == this.packageName &&
          other.limitMinutes == this.limitMinutes &&
...
class UsageLimitsCompanion extends UpdateCompanion<UsageLimit> {
  final Value<int> id;
  final Value<String> packageName;
  final Value<int> limitMinutes;
  final Value<bool> isActive;
  const UsageLimitsCompanion({
    this.id = const Value.absent(),
    this.packageName = const Value.absent(),
    this.limitMinutes = const Value.absent(),
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (limitMinutes.present) {
      map['limit_minutes'] = Variable<int>(limitMinutes.value);
    }
    if (isActive.present) {
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $AppUsageLogsTable appUsageLogs = $AppUsageLogsTable(this);
...
typedef $$VideoLearningLogsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$AppUsageLogsTableCreateCompanionBuilder =
    AppUsageLogsCompanion Function({
      Value<int> id,
      required String packageName,
      required String appName,
      Value<int> durationSeconds,
...
typedef $$AppUsageLogsTableUpdateCompanionBuilder =
    AppUsageLogsCompanion Function({
      Value<int> id,
      Value<String> packageName,
      Value<String> appName,
...
class $$AppUsageLogsTableFilterComposer
    extends Composer<_$AppDatabase, $AppUsageLogsTable> {
  $$AppUsageLogsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$AppUsageLogsTableOrderingComposer
    extends Composer<_$AppDatabase, $AppUsageLogsTable> {
  $$AppUsageLogsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$AppUsageLogsTableAnnotationComposer
    extends Composer<_$AppDatabase, $AppUsageLogsTable> {
  $$AppUsageLogsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$AppUsageLogsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $AppUsageLogsTable,
          ...
          $$AppUsageLogsTableOrderingComposer,
          $$AppUsageLogsTableAnnotationComposer,
          $$AppUsageLogsTableCreateCompanionBuilder,
          $$AppUsageLogsTableUpdateCompanionBuilder,
          (
            AppUsageLog,
            BaseReferences<_$AppDatabase, $AppUsageLogsTable, AppUsageLog>,
          ),
          AppUsageLog,
          PrefetchHooks Function()
        > {
  $$AppUsageLogsTableTableManager(_$AppDatabase db, $AppUsageLogsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$AppUsageLogsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$AppUsageLogsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$AppUsageLogsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
...
typedef $$AppUsageLogsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $AppUsageLogsTable,
      AppUsageLog,
...
class $$UsageLimitsTableFilterComposer
  ...
  ColumnFilters<int> get limitMinutes => $composableBuilder(
    column: $table.limitMinutes,
    builder: (column) => ColumnFilters(column),
  );
...
class $$UsageLimitsTableOrderingComposer
  ...
  ColumnOrderings<int> get limitMinutes => $composableBuilder(
    column: $table.limitMinutes,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$UsageLimitsTableAnnotationComposer
  ...
  GeneratedColumn<int> get limitMinutes => $composableBuilder(
    column: $table.limitMinutes,
    builder: (column) => column,
  );
...
class $$UsageLimitsTableTableManager
    extends
        RootTableManager<
          ...
          (
            UsageLimit,
            BaseReferences<_$AppDatabase, $UsageLimitsTable, UsageLimit>,
          ),
          UsageLimit,
          PrefetchHooks Function()
        > {
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<String> packageName = const Value.absent(),
                Value<int> limitMinutes = const Value.absent(),
...
class $AppDatabaseManager {
  ...
  $$AppUsageLogsTableTableManager get appUsageLogs =>
      $$AppUsageLogsTableTableManager(_db, _db.appUsageLogs);
